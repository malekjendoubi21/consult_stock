...
export class LotsComponent implements OnInit {
  ...
  saveLot(): void {
    if (this.isEditMode && this.currentLot.id) {
      // Mode modification - utiliser UpdateLotDto
      const updateDto = {
        articleId: this.currentLot.articleId,
        numLot: this.currentLot.numLot,
        quantiteDisponible: this.currentLot.quantiteDisponible,
        dateExpiration: this.currentLot.dateExpiration,
        prixUnitaire: this.currentLot.prixUnitaire
      };
      this.lotService.update(this.currentLot.id, updateDto).subscribe({
        next: (data) => {
      ...
      // Mode ajout - utiliser CreateLotDto
      const createDto = {
        articleId: this.currentLot.articleId,
        numLot: this.currentLot.numLot,
        quantiteDisponible: this.currentLot.quantiteDisponible,
      ...
      this.lotService.create(createDto).subscribe({
        next: (data) => {
