...
export class ArticlesComponent implements OnInit {
  ...
  saveArticle(): void {
    if (this.isEditMode && this.currentArticle.id) {
      // Mode modification - utiliser UpdateArticleDto
      const updateDto = {
        nom: this.currentArticle.nom,
        codeArticle: this.currentArticle.codeArticle,
        prixTTC: this.currentArticle.prixTTC,
        prixHT: this.currentArticle.prixHT
      };
      this.articleService.update(this.currentArticle.id, updateDto).subscribe({
        next: (data) => {
      ...
      // Mode ajout - utiliser CreateArticleDto
      const createDto = {
        nom: this.currentArticle.nom,
        codeArticle: this.currentArticle.codeArticle,
        prixTTC: this.currentArticle.prixTTC,
      ...
      this.articleService.create(createDto).subscribe({
        next: (data) => {
