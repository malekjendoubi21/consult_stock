...
namespace consult_stock.Filters
{
    public class SwaggerDocumentFilter : IDocumentFilter
    {
        public void Apply(OpenApiDocument swaggerDoc, DocumentFilterContext context)
        {
            ...
            {
                new OpenApiServer { Url = "https://localhost:7131", Description = "Serveur de développement HTTPS" },
                new OpenApiServer { Url = "http://localhost:5000", Description = "Serveur de développement HTTP" }
            };

            // Ajouter des informations de version et de contact (vérifier si la clé existe déjà)
            ...
            // Ajouter x-logo seulement si elle n'existe pas déjà
