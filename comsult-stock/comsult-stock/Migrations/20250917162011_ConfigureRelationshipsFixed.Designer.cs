...
namespace comsult_stock.Migrations
{
    ...
    [Migration("20250917162011_ConfigureRelationshipsFixed")]
    partial class ConfigureRelationshipsFixed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("comsult_stock.Models.Stock", b =>
                {
                    ...
                    b.HasOne("comsult_stock.Models.Lot", "Lot")
                        .WithMany("Stocks")
                        .HasForeignKey("LotId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("comsult_stock.Models.Vente", b =>
                {
                    b.HasOne("comsult_stock.Models.Article", "ArticleEntity")
                        .WithMany("Ventes")
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("comsult_stock.Models.Lot", "LotEntity")
                        .WithMany()
                        .HasForeignKey("LotId")
                        .OnDelete(DeleteBehavior.Restrict);
